...
assert.match(messageComponent, /All Messages/)
assert.match(messageComponent, /Unread Messages/)
...
assert.match(eventDetails, /isEditingResponsibilities && eventCanChange/)
